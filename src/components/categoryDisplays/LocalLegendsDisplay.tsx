          ...
          <div key={idx} className="flex flex-col items-center">
            <div className="relative">
              <img
                src={lampImage}
                alt="Vintage lamp"
                className="absolute -top-12 left-1/2 transform -translate-x-1/2 w-16 sm:w-20 md:w-24 lg:w-28 z-20 opacity-90"
              />

              <div
                className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-24 sm:w-32 md:w-40 lg:w-48 h-24 filter drop-shadow-[0_0_1rem_rgba(210,180,140,0.6)] mix-blend-screen pointer-events-none z-10"
                style={{
                  clipPath: "polygon(50% 0%, 100% 100%, 0% 100%)",
                  background:
                    "linear-gradient(to bottom, rgba(210,180,140,0.8) 0%, rgba(210,180,140,0.5) 50%, rgba(210,180,140,0) 100%)",
                }}
              />
